...
class Config {
    companion object {
        ...
        val PRODUCT_UPLOADING_TITLE = "Product uploading..."
        val PLEASE_WAIT = "Please wait a moment..."
        val PRODUCT_DELETING_TITLE = "Product deleting..."
        val PRODUCT_DELETE_TITLE = "Are you want to delete this product?"
        val YES = "Yes"
        val NO = "No"
